/// @description sound_define_properties( sound, reverb sound, max volume, min vol dist, max vol dist, vol bias, reverb min, reverb max, min reverb dist, max reverb dist, reverb bias, pan amount )
/// @function sound_define_properties
/// @param  sound
/// @param  reverb sound
/// @param  max volume
/// @param  min vol dist
...
/// @param  reverb min
/// @param  reverb max
/// @param  min reverb dist
/// @param  max reverb dist
/// @param  reverb bias
/// @param  pan amount 
