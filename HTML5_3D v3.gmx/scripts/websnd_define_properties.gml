///websnd_define_properties( sound, pan effect, reverb effect, max volume, min vol dist, max vol dist, vol bias, reverb min, reverb max, min reverb dist, max reverb dist, reverb bias, pan amount )
...
_result[e_websnd.pan_amount     ] = argument12; //pan amount
