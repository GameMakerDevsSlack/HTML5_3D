...
(function() {
  ...
  window.wa_set_sound_property = function(id, property, value) {
    var cur_sound = __sounds[id];
    cur_sound[property] = value;

    __sounds[id] = cur_sound;
  }

  window.wa_set_effect_property = function(id, property, value) {
    var cur_effect = __effects[id];
    cur_effect[property] = value;

    __effects[id] = cur_effect;
  }

  window.wa_create_sound_file_ext = function(path, loop, volume, attack, release, callback) {
  ...
  window.wa_pause_sound = function(id) {
    __sounds[id].pause();
  }
